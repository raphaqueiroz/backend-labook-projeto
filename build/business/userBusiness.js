...
class UserBusiness {
    constructor(userDatabase, idGenerator, tokenManager, hashManager) {
        ...
        this.signup = (input) => __awaiter(this, void 0, void 0, function* () {
            ...
            const verifyEmail = yield this.userDatabase.findUserByEmail(email);
            if (verifyEmail) {
            ...
            const newUser = new User_1.User(id, name, email, hashedPassword, types_1.USER_ROLES.NORMAL, new Date().toISOString());
